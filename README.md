...
## Example
![Image 2023-11-10 at 3 30 PM](https://github.com/tyleroneildev/react-chat-bot/assets/43754564/9eb22eb0-b6a5-4334-8239-488e022c35d2)
...
```bash
git clone https://github.com/tyleroneildev/react-chat-bot.git
cd react-chat-bot
```
...
This project was originally crafted without the use of React. If you're curious to explore its earlier version, you can find the legacy repository by clicking [here](https://github.com/tyleroneildev/chat-bot) 
